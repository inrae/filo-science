...
-- ddl-end --
COMMENT ON COLUMN filo.project.is_active IS 'Specify if the project is currently active';
-- ddl-end --
...
-- ddl-end --
COMMENT ON COLUMN filo.measure_template.measure_template_schema IS 'List of all measures usable by a taxon.
...
-- ddl-end --
COMMENT ON COLUMN filo.analysis_template.analysis_template_schema IS 'Description of all parameters recorded, in Json format';
-- ddl-end --
...
INSERT INTO filo.dbversion (dbversion_number, dbversion_date) VALUES (E'1.2', E'2019-08-29');
-- ddl-end --
...
-- ddl-end --
COMMENT ON COLUMN filo.taxa_template.freshwater IS 'Does the template operate for freshwater?';
-- ddl-end --
...
-- ddl-end --
COMMENT ON TABLE filo.operation_document IS 'Documents associated with an operation';
-- ddl-end --
