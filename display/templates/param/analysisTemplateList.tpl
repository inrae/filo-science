...
<div class="row">
    <div class="col-md-6">
        {if $droits.param == 1}
            <a href="index.php?module=analysisTemplateChange&analysis_template_id=0">
            ...
            <tbody>
                {foreach $data as $row}
                    <tr>
                        ...
                        <td>
                            {if $droits.param == 1}
                                <a href="index.php?module=analysisTemplateChange&analysis_template_id={$row.analysis_template_id}">
