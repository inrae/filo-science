...
<div class="row">
    <div class="col-md-6">
        {if $droits.param == 1}
            <a href="index.php?module=measureTemplateChange&measure_template_id=0">
            ...
            <tbody>
                {foreach $data as $row}
                    <tr>
                        ...
                        <td>
                            {if $droits.param == 1}
                                <a href="index.php?module=measureTemplateChange&measure_template_id={$row.measure_template_id}">
