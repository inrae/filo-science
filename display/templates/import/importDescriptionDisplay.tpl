...
<ul class="nav nav-tabs" id="myTab" role="tablist">
	<li class="nav-item active">
		<a class="nav-link" id="tab-function" data-toggle="tab" role="tab" aria-controls="nav-function"
			aria-selected="true" href="#nav-function">{t}Contrôles et mises en forme{/t}</a>
	</li>
	<li class="nav-item">
		<a class="nav-link" id="tab-mapping" href="#nav-mapping" data-toggle="tab" role="tab"
			aria-controls="nav-mapping" aria-selected="false">{t}Mapping{/t}</a>
	</li>
</ul>
