<h2>{t}Liste des types de transmetteurs{/t}</h2>
<div class="row">
    <div class="col-md-6">
        {if $droits.param == 1}
        <a href="index.php?module=transmitter_typeChange&transmitter_type_id=0">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        {if $droits.param == 1}
                        <a
                            href='index.php?module=transmitter_typeChange&transmitter_type_id={$row["transmitter_type_id"]}'>
