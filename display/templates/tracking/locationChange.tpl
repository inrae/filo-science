    ...
    <div class="col-md-6">
        ...
        <div class="row">   
            <form class="form-horizontal protoform" id="locationForm" method="post" action="index.php">
                ...
                <div class="form-group">
                    <label for="location_long"  class="control-label col-md-4">{t}Longitude :{/t}</label>
                    <div class="col-md-8">
                        <input id="location_long" class="form-control taux" name="location_long" value="{$data.location_long}">
                    </div>
                </div>
                <div class="form-group">
                    <label for="location_lat"  class="control-label col-md-4">{t}Latitude :{/t}</label>
                    <div class="col-md-8">
                        <input id="location_lat" class="form-control taux" name="location_lat" value="{$data.location_lat}">
                    </div>
                </div>
                <div class="form-group">
