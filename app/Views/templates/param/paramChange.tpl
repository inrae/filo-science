...
<div class="row">
  <div class="col-md-6">
    <form class="form-horizontal " id="paramForm" method="post" action="{$tablename}Write">
      ...
      <div class="form-group">
        <label for="paramcode" class="control-label col-md-4">{t}Code métier :{/t}</label>
        <div class="col-md-8">
          <input id="paramCode" type="text" class="form-control" name="{$fieldcode}" value="{$data.$fieldcode}">
        </div>
      </div>
