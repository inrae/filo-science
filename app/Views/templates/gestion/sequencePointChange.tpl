...
<a href="sequenceDisplay?sequence_id={$sequence.sequence_id}&activeTab=tab-point">
    <img src="display/images/display.png" height="25">{t}Retour à la séquence{/t}
</a>
<div class="row">
    <div class="col-md-6">

        <form class="form-horizontal " id="paramForm" method="post" action="sequencePointWrite">
