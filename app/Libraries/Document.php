	...
	function write()
	{
		 ...
		 */
			...
			foreach ($files as $file) {
				$this->id = $this->dataclass->documentWrite($file, $_REQUEST["parent_table"], $_REQUEST["parent_id"], $_REQUEST["document_description"], $_REQUEST["document_creation_date"]);
				if ($this->id > 0) {
